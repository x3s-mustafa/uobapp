...
class _scheduleState extends State<adminschedule> {
  Future Wallt() async {
    ...
    setState(() {
      ...
      for(var i = 0 ; i < prefs.getStringList("schedules_SUBJECT_NAME").length;i++) {
        ...
        if( equals('${prefs.getStringList("schedules_SUBJECT_DEPARTMENT")[i]}', DEPARTMENT)){
          ...
          if(equals('${prefs.getStringList("schedules_SUBJECT_STAGE")[i]}', STAGE)){
            ...
            if(equals('${prefs.getStringList("schedules_SUBJECT_NAME")[i]}', name)){
