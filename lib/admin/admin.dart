...
import 'adminSchedule.dart';
import 'admin_add_materils.dart';
import 'admin_add_topic.dart';
import 'adminnots.dart';
        ...
        Padding(padding: EdgeInsets.only(top: 30,right: 30),child:   Align(
          ...
          child: IconButton(
            ...
            onPressed: (){
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  adminnots()),
              );
            },
          ),
        ),),
            ...
            child:  Container(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>  adminschedule()),
                    );
                  },
          ...
          Padding(
            ...
            child:  Container(
              ...
              child: ElevatedButton(
                  ...
                  child: Text("Students",style: TextStyle(color: Colors.white,fontSize: 15),)
              ),
            ),
          ),
            ...
            child:  Container(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: (){
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>  addmaterilas()),
                    );

                  },
                  child: Text("Add Materils",style: TextStyle(color: Colors.white,fontSize: 15),)
              ),
            ),
          ),
          Padding(
            ...
            child:  Container(
              ...
              child: ElevatedButton(
                  ...
                  child: Text("Add Topic",style: TextStyle(color: Colors.white,fontSize: 15),)
              ),
            ),
          ),
