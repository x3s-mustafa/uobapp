  ...
  Future Wallt() async {
    ...
    setState(() {
      ...
      for(var i = 0 ; i < prefs.getStringList("Topic_NAME").length;i++) {
        ...
        if( equals('${prefs.getStringList("TOPIC")[i]}', topicname)){
          ...
          subtopic.add(
              prefs.getStringList("SUB_TOPIC")[i]
        ...
        children: [
          Padding(padding: EdgeInsets.only(top: 65),child: Align(
            ...
            child: Container(
              ...
              child: Center(
                child: Text("$Subjectname - $topicname",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),),
              ),
              height: 50,
              ...
              itemBuilder: (BuildContext ctxt, int Index) {
                return new Bounce(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Padding(padding: EdgeInsets.only(left: 10),child:  Column(
                                      ...
                                      children: [
                                        Padding(padding: EdgeInsets.only(bottom: 10,),child:  Text("${topic[Index]}",style: TextStyle(color: Colors.grey,fontSize: 12),),),
                                        Text("${subtopic[Index]}",style: TextStyle(color: Color(0xff00C76B),fontSize: 16,fontWeight: FontWeight.w500),),
                  ...
                  onPressed: (){
                    ...
                    subtopicname = subtopic[Index];
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>  soures()),
                    );
